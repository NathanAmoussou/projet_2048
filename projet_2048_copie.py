...
def stop():
    ...
    bouton_stop.after(100, bouton_save.destroy)
...
bouton_save = tk.Button(racine, text="Save", font=('Helvetica','15'), command=lambda: save_config('etat_var.json', configuration_courante))
bouton_load = tk.Button(racine, text="Load", font=('Helvetica','15'), command=lambda: load_config('etat_var.json'))
